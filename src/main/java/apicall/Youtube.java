...
public class Youtube {
    ...
    public static String search(String query) {
        ...
        try {
            ...
            }).setYouTubeRequestInitializer(new YouTubeRequestInitializer("AIzaSyBxEe2wqvlb1d_JVriIh1fZIbjOeOGYbkw")).setApplicationName("youtube-cmdline-search-sample").build();
            ...
            String apiKey = "AIzaSyBxEe2wqvlb1d_JVriIh1fZIbjOeOGYbkw";
